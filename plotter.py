...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--root-dir', default='D:/NJUPT/coding/final_project/mopo-master/log', help='root dir'
    )
    parser.add_argument(
        '--task', default='portfolio-medium-replay-v2', help='task'
    )
    parser.add_argument(
    ...
    parser.add_argument('--show', default=True, action='store_true', help='show figure')
    parser.add_argument(
